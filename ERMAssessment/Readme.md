...
To view your deployed application open the Stack View window by float-clicking the stack name shown beneath the AWS CloudFormation node in the AWS Explorer tree. The Stack View also displays the root URL to your published application.
...
Execute unit tests
```
    cd "ERMAssessment/test/ERMAssessment.Tests"
    dotnet test
```

Deploy application
```
    cd "ERMAssessment/src/ERMAssessment"
